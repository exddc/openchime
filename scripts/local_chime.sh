...
Environment overrides:
  ...
  CHIME_WEBD_NETWORK_RESTART_CMD  executable + argv, no shell (default: true locally)
  CHIME_WEBD_CHIME_RESTART_CMD    executable + argv, no shell (default: true locally)
