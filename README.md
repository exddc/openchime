...
**Hardware:** Raspberry Pi Zero 2 W, I2S audio, Camera Module 3 Wide, two relays, 1–4 Kailh BOX buttons on a key board, and a power board with two Class II mains modules in a heated sealed enclosure. See [Ring hardware](hardware/ring/README.md).
