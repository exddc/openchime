...
| U7 | 1 | Ring power board, custom PCB, [definition](boards.md) | Per components | Schematic and layout pending |
...
| J72–J74, J77 | 4 | 2-circuit terminals, ≥ 3 A per contact, 22 AWG |
...
| 22 AWG internal wire | 1.60 m cut; 1.92 m with 20% waste |
| 26 AWG internal wire, including 60 mm of local straps | 4.71 m cut; 5.65 m with 20% waste |
| Speaker lead | 100 mm pair from included factory lead |
| Camera ribbon | One 200 mm cable |

Allow approximately 8.4 m of loose wire, distributed across the listed gauges and colours. Factory speaker and camera cables are additional.
